...
class WeChatMomentDemoVC: UIViewController {
    ...
    deinit {
        for label in WeChatMomentDemoVC.propertyLabel {
...
extension WeChatMomentDemoVC: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
